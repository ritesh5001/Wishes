...
const NotFound = () => (
  <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-brand-50 via-white to-emerald-50 px-4 text-center dark:from-slate-950 dark:via-slate-950 dark:to-slate-900">
